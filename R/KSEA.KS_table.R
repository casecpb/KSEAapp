...
#' 
#' @return creates a new data frame in R with all kinase-substrate relationships used for the KSEA calculations
#' 
#' @references 
...
KSEA.KS_table = function (KSData, PX, NetworKIN, NetworKIN.cutoff){
